        ...
        <div className="relative">
          ...
          <header className="flex justify-center items-center relative min-h-screen w-full bg-green-100">
            <div className="text-center">
              <h1 className="text-6xl font-bold text-green-700 mb-6 font-dancing">
                Furever Home
              </h1>
              ...
              <Button
                ...
                className="bg-brown-500 hover:bg-green-900 py-3 px-6 text-white rounded-xl"
              >
                View Available Pets
              </Button>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  <Image
                    ...
                    height={64}
                    alt="Paw"
                    className="object-cover w-[250px] rounded-xl mx-auto mb-4"
                  />
          ...
          <section ref={featuredPetsRef} className="px-6 py-16 bg-green-50">
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { n: 'Lora', d: 'Male poddle in search of a owner' },
                  { n: 'Jacky', d: 'Triplets waiting for a lovely home' },
                  {
                    n: 'Elisa',
                    d: 'Finding someone to spend rest of her life with',
                  },
                ].map((i, ind) => (
                  <div
                    key={ind}
                  ...
                  >
                    ...
                    />
                    <div className="p-4">
                      <h3 className="text-xl font-semibold mb-2">{i.n}</h3>
                      <p className="text-gray-600 mb-4">{i.d}</p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="flex flex-col justify-center items-center gap-8">
                <div className="flex flex-col justify-center items-center gap-4">
                  ...
                  <p className="mb-4">
                    Have questions about adoption? We're here to help!
                  </p>
                  <ContactForm />
                </div>
                <div className="flex flex-col justify-center items-center gap-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a href="#" className="text-white hover:text-green-300">
                      <svg
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path d="M12 2C6.48 2 2 6.48 2 12c0 5.52 4.48 10 10 10s10-4.48 10-10S17.52 2 12 2zm-2.5 17.5V13H8v-3h1.5V8.5c0-1.5.92-2.5 2.26-2.5H13v3h-1.5c-.25 0-.5.25-.5.5v1.5h2.5l-.5 3h-2v6.5h-3z" />
                      </svg>
                    </a>
                    <a href="#" className="text-white hover:text-green-300">
                      <svg
              ...
              <div className="mt-8 text-center">
                <p>
                  © {new Date().getFullYear()} Furever Home. All rights
                  reserved.
                </p>
              </div>
            </div>
